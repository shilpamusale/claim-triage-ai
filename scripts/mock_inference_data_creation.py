...
def create_mock_inference_data_v5() -> None:
    """
    ...
    notes_map = {
        "auth": [
            "Follow-up with payer; no auth found.",
            "Retro-auth request faxed.",
            "Escalated to auth team.",
        ],
        "necessity": [
            "Peer-to-peer scheduled.",
            "Appeal letter submitted.",
            "Clinical review notes sent.",
        ],
        "misc": [
            "COB updated with primary payer.",
            "Duplicate claim voided.",
            "Corrected claim pending resubmission.",
        ],
        "eligibility": [
            "Eligibility confirmed with payer rep.",
            "Coverage terminated letter received.",
            "Patient asked for updated ID card.",
        ],
        "coding": [
            "Coding team reviewing CPT/ICD mapping.",
